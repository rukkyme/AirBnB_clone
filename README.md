0x00. AirBnB clone - The console Group project Python OOP By: Guillaume Weight: 5
...
Documented commands (type help ): EOF help quit (hbnb) $ All tests should also pass in non-interactive mode: $ echo "python3 -m unittest discover tests" | bash
